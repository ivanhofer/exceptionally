...
- `neverthrow`: [link to library](https://github.com/supermacro/neverthrow)
- `result`: [link to library](https://github.com/badrap/result)

|                                                                                     | `exceptionally` | `[data,error] tuple` | `{data,error} object` | `neverthrow` | `result` |
| ----------------------------------------------------------------------------------- | --------------- | -------------------- | --------------------- | ------------ | -------- |
